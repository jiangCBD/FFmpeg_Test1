...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/2023_video/ffmpeg-6.1 --enable-gpl --enable-libx264 --disable-static --enable-shared --extra-cflags=-l/e/2023_video/ffmpeg-6.1/x264_install/include --extra-ldflags=-L/e/2023_video/ffmpeg-6.1/x264_install/lib
...
CFLAGS=  -l/e/2023_video/ffmpeg-6.1/x264_install/include -std=c11 -fomit-frame-pointer  -IE:/2023_video/ffmpeg-6.1/x264_install/include -DX264_API_IMPORTS -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -l/e/2023_video/ffmpeg-6.1/x264_install/include -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/e/2023_video/ffmpeg-6.1/x264_install/lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -latomic -lvfw32
...
EXTRALIBS-avcodec=-liconv -lm -latomic -llzma -LE:/2023_video/ffmpeg-6.1/x264_install/lib -lx264 -lmfuuid -lole32 -lstrmiids -lole32 -luser32 -lz
